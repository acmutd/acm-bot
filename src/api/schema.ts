...
export const ResponseSchema = model<Response>('response', responseSchema, 'responses')
export const RRMessageSchema = model<RRMessage>('rrmessage', rrSchema, 'rrmessages')
