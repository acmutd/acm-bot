...
import { Member, Response, RRMessage, RRMessageData, TaskData, Circle, CircleData, MemberSchema, ResponseSchema, RRMessageSchema, TaskSchema, CircleSchema } from '../../api/schema'
...
export default class DatabaseManager extends Manager {
    ...
    public async responseAdd(type: ResponseType, message: string): Promise<boolean> {
        try {
