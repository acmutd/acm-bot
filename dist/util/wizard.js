            ...
            if (this.options.loopedCB) {
                ...
                do {
                    do {
                        ...
                        if (((_a = response.first()) === null || _a === void 0 ? void 0 : _a.content.toLowerCase()) === this.wizard.configs.commands.quit) {
                            wizardNode.delete();
                            this.wizard.message.channel.send(this.wizard.configs.responses.quit);
                            return { status: WizardNodeResponseStatus.INCOMPLETE, item: false };
                        }
                        if (this.options.skipValue) {
                            if (((_b = response.first()) === null || _b === void 0 ? void 0 : _b.content.toLowerCase()) === this.wizard.configs.commands.skip) {
                                wizardNode.delete();
                                return { status: WizardNodeResponseStatus.COMPLETE, item: this.options.skipValue };
                            }
                        }
                        if (((_c = response.first()) === null || _c === void 0 ? void 0 : _c.content.toLowerCase()) === this.wizard.configs.commands.doneLoop) {
                ...
                do {
                    ...
                    if (((_e = response.first()) === null || _e === void 0 ? void 0 : _e.content.toLowerCase()) === this.wizard.configs.commands.quit) {
                        wizardNode.delete();
                        this.wizard.message.channel.send(this.wizard.configs.responses.quit);
                        return { status: WizardNodeResponseStatus.INCOMPLETE, item: false };
                    }
                    if (this.options.skipValue) {
                        if (((_f = response.first()) === null || _f === void 0 ? void 0 : _f.content.toLowerCase()) === this.wizard.configs.commands.skip) {
                            wizardNode.delete();
                            return { status: WizardNodeResponseStatus.COMPLETE, item: this.options.skipValue };
                        }
                    }
