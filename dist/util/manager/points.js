...
class PointsManager extends manager_1.default {
    ...
    handleReactionAdd(reaction, user) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (user.id === ((_a = this.bot.user) === null || _a === void 0 ? void 0 : _a.id) ||
                msg.channel.id !== this.privateChannelId ||
                msg.author.id !== ((_b = this.bot.user) === null || _b === void 0 ? void 0 : _b.id) ||
                !reaction.users.cache.has((_c = this.bot.user) === null || _c === void 0 ? void 0 : _c.id) ||
                reaction.emoji.name !== "✅" ||
                msg.embeds.length !== 1 ||
                !msg.embeds[0].title ||
