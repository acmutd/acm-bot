    ...
    createTask(task) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (t.id) {
                ...
                t.id = uuid_1.v4();
            const search = yield this.bot.managers.database.schemas.task.find({
                _id: t.id,
            });
            if (search.length == 0)
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (task.type) {
                case "newsletter":
                    ...
                    break;
                case "reminder":
                    (_b = (_a = this.bot.guilds.cache
                        .first()) === null || _a === void 0 ? void 0 : _a.members.cache.get(task.payload.id)) === null || _b === void 0 ? void 0 : _b.send(task.payload.message);
                    break;
                case "rsvp_reminder":
                    break;
                case "caretaker":
