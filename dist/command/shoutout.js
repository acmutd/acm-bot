...
class ShoutoutCommand extends command_1.default {
    ...
    exec({ msg, bot, args }) {
        ...
        if (receivers.length > 0)
            title += `${receivers
                .map((m) => { var _a; return (_a = m.nickname) !== null && _a !== void 0 ? _a : m.user.username; })
                .join(", ")}${receivers.length > 0 ? ", and " : ""}${(_c = last === null || last === void 0 ? void 0 : last.nickname) !== null && _c !== void 0 ? _c : last === null || last === void 0 ? void 0 : last.user.username}`;
        else
            ...
            fields: [
                {
                    ...
                    value: msg.content
                        .match(reg)[0]
                        .replace(settings_1.settings.prefix + "shoutout", ""),
                },
                {
                    name: "For:",
                    value: text,
